...
BEGIN_EVENT_TABLE(War_GameDialog, wxDialog)
    EVT_CLOSE(War_GameDialog::OnClose)
    EVT_BUTTON(idBtnQuit, War_GameDialog::OnQuit)
    EVT_BUTTON(idBtnAbout, War_GameDialog::OnAbout)
END_EVENT_TABLE()

War_GameDialog::War_GameDialog(wxDialog *dlg, const wxString &title)
...
War_GameDialog::~War_GameDialog()
{
}

void War_GameDialog::OnClose(wxCloseEvent &event)
{
    Destroy();
}

void War_GameDialog::OnQuit(wxCommandEvent &event)
{
    Destroy();
}

void War_GameDialog::OnAbout(wxCommandEvent &event)
{
